...
// After that, I followed the online documentation for vcpkg: https://vcpkg.io/en/getting-started.html
	...
	// Command: vcpkg install pthreads:x64-windows 
		// may be different on your machine, check the intellisense suggestion on the #include <pthread.h> line
